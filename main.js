...
*/
  ...
  var $author$project$APIPage$Model = F2(function (nasaImage, randomJoke) {
  ...
  var $author$project$APIPage$NasaImage = F2(function (url, mediaType) {
  ...
  var $author$project$APIPage$Joke = F2(function (setup, delivery) {
        ...
        _List_fromArray([
          $elm$http$Http$get({
            expect: A2(
              ...
              $author$project$APIPage$GotImage,
              $author$project$APIPage$imageDecoder,
            ),
          ...
          $elm$http$Http$get({
            expect: A2(
              $elm$http$Http$expectJson,
              $author$project$APIPage$GotJoke,
              $author$project$APIPage$randomJokeDecoder,
            ),
  ...
  var $author$project$CVPage$Model = F3(function (test, message, tab) {
  ...
  var $author$project$CVPage$init = function (_v0) {
    return _Utils_Tuple2(
      A3(
        $author$project$CVPage$Model,
        "Starting it up",
        $elm$core$Maybe$Nothing,
        $author$project$CVPage$Academic,
      ),
      $elm$core$Platform$Cmd$none,
    );
  };
  var $author$project$MainPage$Model = F2(function (test, message) {
    return { message: message, test: test };
  });
  var $author$project$MainPage$init = function (_v0) {
    return _Utils_Tuple2(
      A2(
        $author$project$MainPage$Model,
        "Starting it up",
        $elm$core$Maybe$Nothing,
      ),
      $elm$core$Platform$Cmd$none,
  ...
  var $author$project$Navigation$PageInfo = F2(function (name, page) {
  ...
  var $author$project$Navigation$pageList = _List_fromArray([
    _Utils_Tuple2(
      "",
      A2(
        $author$project$Navigation$PageInfo,
        "Home",
        $author$project$Navigation$Main,
      ),
    ),
    _Utils_Tuple2(
      "#Experience",
    ...
    _Utils_Tuple2(
      ...
      A2(
        $author$project$Navigation$PageInfo,
        "Misc",
        $author$project$Navigation$APITest,
      ),
    ),
  ]);
  var $author$project$Navigation$pageMap = $elm$core$Dict$fromList(
  ...
  var $author$project$APIPage$update = F2(function (msg, model) {
    if (msg.$ === "GotImage") {
      var result = msg.a;
      if (result.$ === "Ok") {
        var image = result.a;
  ...
  var $author$project$CVPage$downloadCV =
    $elm$file$File$Download$url("Files/CV.pdf");
  var $author$project$CVPage$downloadThesis =
    $elm$file$File$Download$url("Files/thesis.pdf");
  var $author$project$CVPage$saveFrog =
    $elm$file$File$Download$url("Files/frog.jpg");
  var $author$project$CVPage$update = F2(function (msg, mdl) {
    switch (msg.$) {
      case "DownloadFile":
      ...
      default:
        var tab = msg.a;
        return _Utils_Tuple2(
          _Utils_update(mdl, { tab: tab }),
          $elm$core$Platform$Cmd$none,
        );
    }
  });
  var $author$project$MainPage$update = F2(function (msg, model) {
    var s = msg.a;
  ...
  var $author$project$Main$update = F2(function (msg, model) {
    switch (msg.$) {
        ...
        var urlString = A2(
          ...
          $elm$core$List$head(
            $elm$core$List$reverse(
              A2($elm$core$String$split, "#", $elm$url$Url$toString(url)),
            ),
          ),
        );
        var route = A2(
        ...
        if (route.$ === "Just") {
          ...
          switch (_v3.$) {
            ...
            case "Redshift":
              return _Utils_Tuple2(
                _Utils_update(model, {
                  currentPage: $author$project$Navigation$Redshift,
                  url: url,
                }),
                $elm$core$Platform$Cmd$none,
              );
      ...
      case "MainMsg":
        ...
        if (_v8.$ === "Just") {
          var a = _v8.a;
          var _v9 = A2($author$project$MainPage$update, b, a);
          var m = _v9.a;
          var c = _v9.b;
          return _Utils_Tuple2(
            _Utils_update(model, {
      ...
      case "APIMsg":
        ...
        if (_v10.$ === "Just") {
          var a = _v10.a;
          var _v11 = A2($author$project$APIPage$update, b, a);
          var m = _v11.a;
          var c = _v11.b;
          return _Utils_Tuple2(
            _Utils_update(model, {
      ...
      return $rtfeldman$elm_css$Css$Preprocess$Snippet(
        _List_fromArray([
          $rtfeldman$elm_css$Css$Preprocess$StyleBlockDeclaration(
            A3(
              $rtfeldman$elm_css$Css$Preprocess$StyleBlock,
              sel,
              _List_Nil,
              styles,
            ),
  ...
  var $rtfeldman$elm_css$Css$Global$body =
    $rtfeldman$elm_css$Css$Global$typeSelector("body");
  ...
  var $rtfeldman$elm_css$VirtualDom$Styled$unstyledNode =
    $rtfeldman$elm_css$VirtualDom$Styled$Unstyled;
  var $rtfeldman$elm_css$Html$Styled$fromUnstyled =
    $rtfeldman$elm_css$VirtualDom$Styled$unstyledNode;
      ...
      switch (declaration.$) {
        case "StyleBlockDeclaration":
          ...
          return $elm$core$List$isEmpty(properties)
            ? _Utils_Tuple2(keyframesByName, declarations)
            : _Utils_Tuple2(
                keyframesByName,
        ...
        case "SupportsRule":
          ...
          return $elm$core$List$isEmpty(otherDeclarations)
            ? _Utils_Tuple2(keyframesByName, declarations)
            : _Utils_Tuple2(
                keyframesByName,
                A2($elm$core$List$cons, declaration, declarations),
        ...
        case "Keyframes":
          ...
          return $elm$core$String$isEmpty(record.declaration)
            ? _Utils_Tuple2(keyframesByName, declarations)
            : _Utils_Tuple2(
                A3(
  ...
  var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
    ...
    var finalDeclarations = A2(
      $rtfeldman$elm_css$Css$Structure$withKeyframeDeclarations,
      keyframesByName,
      compactedDeclarations,
    );
    return {
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$charsetToString = function (
    charset,
  ) {
    return A2(
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$mediaExpressionToString =
    function (expression) {
      return (
        "(" +
        (expression.feature +
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$mediaTypeToString = function (
    mediaType,
  ) {
    switch (mediaType.$) {
      case "Print":
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$mediaQueryToString = function (
    mediaQuery,
  ) {
      ...
      return (
        ...
        (" " +
          A2(
            ...
            A2(
              $elm$core$List$cons,
              $rtfeldman$elm_css$Css$Structure$Output$mediaTypeToString(
                mediaType,
              ),
              A2(
                $elm$core$List$map,
                $rtfeldman$elm_css$Css$Structure$Output$mediaExpressionToString,
                expressions,
              ),
            ),
          ))
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$importMediaQueryToString = F2(
    function (name, mediaQuery) {
      return (
        '@import \"' +
        (name +
          ($rtfeldman$elm_css$Css$Structure$Output$mediaQueryToString(
            mediaQuery,
          ) +
            '\"'))
      );
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$namespaceToString = function (
    _v0,
  ) {
    var prefix = _v0.a;
    var str = _v0.b;
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$emitProperties = function (
    properties,
  ) {
    return A2(
      $elm$core$String$join,
      ...
      A2(
        ...
        A2(
          ...
          $rtfeldman$elm_css$Css$Structure$Output$emitProperty,
        ),
        properties,
      ),
    );
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$pseudoElementToString = function (
    _v0,
  ) {
    var str = _v0.a;
    return "::" + str;
  };
  var $rtfeldman$elm_css$Css$Structure$Output$combinatorToString = function (
    combinator,
  ) {
    switch (combinator.$) {
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$repeatableSimpleSelectorToString =
    function (repeatableSimpleSelector) {
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$simpleSelectorSequenceToString =
    function (simpleSelectorSequence) {
        ...
        case "TypeSelectorSequence":
          ...
          return A2(
            ...
            A2(
              ...
              A2(
                $elm$core$List$map,
                $rtfeldman$elm_css$Css$Structure$Output$repeatableSimpleSelectorToString,
                repeatableSimpleSelectors,
              ),
            ),
          );
        case "UniversalSelectorSequence":
          var repeatableSimpleSelectors = simpleSelectorSequence.a;
          return $elm$core$List$isEmpty(repeatableSimpleSelectors)
            ? "*"
            : A2(
                $elm$core$String$join,
                "",
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$selectorChainToString = function (
    _v0,
  ) {
    ...
    return A2(
      ...
      _List_fromArray([
        ...
        $rtfeldman$elm_css$Css$Structure$Output$simpleSelectorSequenceToString(
          sequence,
        ),
      ]),
    );
  };
  var $rtfeldman$elm_css$Css$Structure$Output$selectorToString = function (
    _v0,
  ) {
    ...
    var segments = A2(
      ...
      A2(
        $elm$core$List$map,
        $rtfeldman$elm_css$Css$Structure$Output$selectorChainToString,
        chain,
      ),
    );
    var pseudoElementsString = A2(
      ...
      _List_fromArray([
        A2(
          ...
          A2(
            $elm$core$Maybe$map,
            $rtfeldman$elm_css$Css$Structure$Output$pseudoElementToString,
            pseudoElement,
          ),
        ),
      ]),
  ...
  var $rtfeldman$elm_css$Css$Structure$Output$prettyPrintDeclaration =
    function (decl) {
      switch (decl.$) {
        case "StyleBlockDeclaration":
          var styleBlock = decl.a;
          return A2(
            $rtfeldman$elm_css$Css$Structure$Output$prettyPrintStyleBlock,
            $rtfeldman$elm_css$Css$Structure$Output$noIndent,
            styleBlock,
          );
        case "MediaRule":
          ...
          var blocks = A2(
            ...
            A2(
              ...
              A2(
                ...
                $rtfeldman$elm_css$Css$Structure$Output$indent,
                $rtfeldman$elm_css$Css$Structure$Output$prettyPrintStyleBlock(
                  $rtfeldman$elm_css$Css$Structure$Output$spaceIndent,
                ),
              ),
              styleBlocks,
            ),
      ...
      A2(
        ...
        _List_fromArray([
          ...
          A2(
            ...
            A2(
              $elm$core$List$map,
              $rtfeldman$elm_css$Css$Structure$Output$importToString,
              imports,
            ),
          ),
          A2(
            ...
            A2(
              $elm$core$List$map,
              $rtfeldman$elm_css$Css$Structure$Output$namespaceToString,
              namespaces,
            ),
          ),
          A2(
            ...
            A2(
              $elm$core$List$map,
              $rtfeldman$elm_css$Css$Structure$Output$prettyPrintDeclaration,
              declarations,
            ),
          ),
        ]),
  ...
  var $rtfeldman$elm_css$Css$Structure$withPropertyAppended = F2(
    function (property, _v0) {
      ...
      return A3(
        ...
        firstSelector,
        otherSelectors,
        _Utils_ap(properties, _List_fromArray([property])),
      );
    },
  );
            ...
            case "StyleBlockDeclaration":
              ...
              return _List_fromArray([
                $rtfeldman$elm_css$Css$Structure$StyleBlockDeclaration(
                  A2(
                    $rtfeldman$elm_css$Css$Structure$withPropertyAppended,
                    property,
                    styleBlock,
                  ),
                ),
  ...
  var $rtfeldman$elm_css$Css$Structure$UniversalSelectorSequence = function (
    a,
  ) {
      ...
      switch (sequence.$) {
        case "TypeSelectorSequence":
          ...
          return A2(
            $rtfeldman$elm_css$Css$Structure$TypeSelectorSequence,
            typeSelector,
            _Utils_ap(list, _List_fromArray([selector])),
          );
        case "UniversalSelectorSequence":
          var list = sequence.a;
        ...
        if (!list.b.b) {
          ...
          return _List_fromArray([
            _Utils_Tuple2(
              combinator,
              A2(
                $rtfeldman$elm_css$Css$Structure$appendRepeatable,
                selector,
                sequence,
              ),
            ),
          ...
          return A2(
            ...
            first,
            A2(
              $rtfeldman$elm_css$Css$Structure$appendRepeatableWithCombinator,
              selector,
              rest,
            ),
          );
  ...
  var $rtfeldman$elm_css$Css$Preprocess$Resolve$collectSelectors = function (
    declarations,
  ) {
            ...
            switch (declarations.a.$) {
              ...
              case "DocumentRule":
                ...
                return A2(
                  $elm$core$List$map,
                  A4(
                    $rtfeldman$elm_css$Css$Structure$DocumentRule,
                    str1,
                    str2,
                    str3,
                    str4,
      ...
      ? data.seed ^
        A2(
          ...
          A2(
            ...
            A2(
              $rtfeldman$elm_css$ElmCssVendor$Murmur3$multiplyBy,
              $rtfeldman$elm_css$ElmCssVendor$Murmur3$c1,
              data.hash,
            ),
          ),
        )
    ...
    return A2(
      ...
      $rtfeldman$elm_hex$Hex$toString(
        A2(
          ...
          $rtfeldman$elm_css$Hash$murmurSeed,
          str,
        ),
      ),
    );
  ...
  var $rtfeldman$elm_css$Css$Preprocess$Resolve$lastDeclaration = function (
    declarations,
  ) {
  ...
  var $rtfeldman$elm_css$Css$Preprocess$Resolve$resolveFontFeatureValues =
    function (tuples) {
      ...
      switch (declaration.$) {
        case "StyleBlockDeclaration":
          ...
          return A2(
            $rtfeldman$elm_css$Css$Structure$MediaRule,
            mediaQueries,
            _List_fromArray([structureStyleBlock]),
          );
        case "MediaRule":
        ...
        case "SupportsRule":
          ...
          return A2(
            ...
            A2(
              $elm$core$List$map,
              $rtfeldman$elm_css$Css$Preprocess$Resolve$toMediaRule(
                mediaQueries,
              ),
              declarations,
            ),
    ...
    function (nestedStyles, rest, f, declarations) {
      ...
      var nextResult = A2(
        ...
        A2(
          $elm$core$Maybe$withDefault,
          _List_Nil,
          $rtfeldman$elm_css$Css$Preprocess$Resolve$lastDeclaration(
            declarations,
          ),
        ),
      );
      var newDeclarations = (function () {
        ...
        if (_v14.a.$ === "Just" && _v14.b.$ === "Just") {
          ...
          return _Utils_ap(
            ...
            _List_fromArray([
              !_Utils_eq(originalParent, nextResultParent)
                ? nextResultParent
                : originalParent,
            ]),
          );
      ...
      return _Utils_ap(
        newDeclarations,
        _Utils_ap(withoutParent(initialResult), withoutParent(nextResult)),
      );
    },
  );
        ...
        switch (styles.a.$) {
          case "AppendProperty":
            ...
            return A2(
              ...
              rest,
              A2(
                $rtfeldman$elm_css$Css$Structure$appendProperty,
                property,
                declarations,
              ),
            );
          case "ExtendSelector":
            ...
            return A4(
              ...
              nestedStyles,
              rest,
              $rtfeldman$elm_css$Css$Structure$appendRepeatableToLastSelector(
                selector,
              ),
              declarations,
            );
            ...
            var chain = F2(function (_v9, _v10) {
              ...
              return A3(
                ...
                $rtfeldman$elm_css$Css$Preprocess$Resolve$oneOf(
                  _List_fromArray([newPseudoElement, originalPseudoElement]),
                ),
              );
            });
            var expandDeclaration = function (declaration) {
              switch (declaration.$) {
                ...
                case "MediaRule":
                  ...
                  var styleBlocks = declaration.b;
                  return A2(
                    $rtfeldman$elm_css$Css$Preprocess$Resolve$resolveMediaRule,
                    mediaQueries,
                    styleBlocks,
                  );
                case "SupportsRule":
                  ...
                  return A2(
                    $rtfeldman$elm_css$Css$Preprocess$Resolve$resolveSupportsRule,
                    str,
                    otherSnippets,
                  );
                case "DocumentRule":
                  ...
                  return A2(
                    $elm$core$List$map,
                    A4(
                      $rtfeldman$elm_css$Css$Preprocess$Resolve$toDocumentRule,
                      str1,
                      str2,
                      str3,
                      str4,
                    ),
                    $rtfeldman$elm_css$Css$Preprocess$Resolve$expandStyleBlock(
                      styleBlock,
                    ),
                  );
                case "PageRule":
                  ...
                  return _List_fromArray([
                    A2(
                      $rtfeldman$elm_css$Css$Structure$PageRule,
                      str,
                      properties,
                    ),
                  ]);
                ...
                default:
                  var tuples = declaration.a;
                  return $rtfeldman$elm_css$Css$Preprocess$Resolve$resolveFontFeatureValues(
                    tuples,
                  );
              }
            };
          ...
          case "WithPseudoElement":
            ...
            return A4(
              ...
              nestedStyles,
              rest,
              $rtfeldman$elm_css$Css$Structure$appendPseudoElementToLastSelector(
                pseudoElement,
              ),
              declarations,
            );
          ...
          case "WithMedia":
            ...
            var extraDeclarations = (function () {
              ...
              if (!_v13.b) {
                ...
                return A2(
                  $elm$core$List$map,
                  $rtfeldman$elm_css$Css$Structure$styleBlockToMediaRule(
                    mediaQueries,
                  ),
                  A2(
                    $rtfeldman$elm_css$Css$Preprocess$Resolve$applyStyles,
  ...
  var $rtfeldman$elm_css$Css$Preprocess$Resolve$expandStyleBlock = function (
    _v2,
  ) {
  ...
  var $rtfeldman$elm_css$Css$Preprocess$Resolve$extract = function (
    snippetDeclarations,
  ) {
  ...
  var $rtfeldman$elm_css$Css$Preprocess$Resolve$toDeclarations = function (
    snippetDeclaration,
  ) {
    switch (snippetDeclaration.$) {
      case "StyleBlockDeclaration":
        var styleBlock = snippetDeclaration.a;
        return $rtfeldman$elm_css$Css$Preprocess$Resolve$expandStyleBlock(
          styleBlock,
        );
      case "MediaRule":
  ...
  var $rtfeldman$elm_css$Css$Preprocess$Resolve$compile = function (styles) {
    return A2(
      ...
      A2(
        $elm$core$List$map,
        $rtfeldman$elm_css$Css$Preprocess$Resolve$compileHelp,
        styles,
      ),
    );
  };
  ...
  var $rtfeldman$elm_css$Css$withPrecedingHash = function (str) {
    return A2($elm$core$String$startsWith, "#", str)
      ? str
      : A2($elm$core$String$cons, _Utils_chr("#"), str);
  };
          ...
          switch (_char.valueOf()) {
            ...
            case "2":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 2 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "3":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 3 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "4":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 4 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "5":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 5 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "6":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 6 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "7":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 7 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "8":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 8 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "9":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 9 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "a":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 10 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "b":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 11 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "c":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 12 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "d":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 13 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "e":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 14 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
            case "f":
              var $temp$position = position - 1,
                $temp$chars = rest,
                $temp$accumulated =
                  accumulated + 15 * A2($elm$core$Basics$pow, 16, position);
              position = $temp$position;
              chars = $temp$chars;
              accumulated = $temp$accumulated;
              continue fromStringHelp;
  ...
  var $rtfeldman$elm_css$Css$validHex = F5(function (str, _v0, _v1, _v2, _v3) {
    ...
    var results = _Utils_Tuple2(
      _Utils_Tuple2(
        toResult(_List_fromArray([r1, r2])),
        toResult(_List_fromArray([g1, g2])),
      ),
      _Utils_Tuple2(
        toResult(_List_fromArray([b1, b2])),
        toResult(_List_fromArray([a1, a2])),
      ),
    );
    if (
      results.a.a.$ === "Ok" &&
  ...
  var $rtfeldman$elm_css$Css$hex = function (str) {
    var withoutHash = A2($elm$core$String$startsWith, "#", str)
      ...
      if (_v0.b && _v0.b.b && _v0.b.b.b) {
        if (!_v0.b.b.b.b) {
          ...
          return A5(
            ...
            _Utils_Tuple2(g, g),
            _Utils_Tuple2(b, b),
            _Utils_Tuple2(_Utils_chr("f"), _Utils_chr("f")),
          );
        } else {
          if (!_v0.b.b.b.b.b) {
            var r = _v0.a;
  ...
  var $rtfeldman$elm_css$VirtualDom$Styled$accumulateStyles = F2(
    function (_v0, styles) {
      var newStyles = _v0.b;
      var classname = _v0.c;
      return $elm$core$List$isEmpty(newStyles)
        ? styles
        : A3($elm$core$Dict$insert, classname, newStyles, styles);
    },
  );
  var $rtfeldman$elm_css$VirtualDom$Styled$extractUnstyledAttribute = function (
    _v0,
  ) {
    var val = _v0.a;
    return val;
    ...
    function (_v6, _v7) {
      ...
      switch (html.$) {
        case "Unstyled":
          var vdom = html.a;
          return _Utils_Tuple2(
            A2($elm$core$List$cons, _Utils_Tuple2(key, vdom), pairs),
            styles,
          );
        case "Node":
          var elemType = html.a;
          ...
          var children = html.c;
          var combinedStyles = A3(
            $elm$core$List$foldl,
            $rtfeldman$elm_css$VirtualDom$Styled$accumulateStyles,
            styles,
            properties,
          );
          var _v9 = A3(
          ...
          var vdom = A3(
            ...
            A2(
              $elm$core$List$map,
              $rtfeldman$elm_css$VirtualDom$Styled$extractUnstyledAttribute,
              properties,
            ),
  ...
  var $rtfeldman$elm_css$VirtualDom$Styled$stylesFromProperties = function (
    properties,
  ) {
    var _v0 = A2(
      $rtfeldman$elm_css$VirtualDom$Styled$stylesFromPropertiesHelp,
      $elm$core$Maybe$Nothing,
      properties,
    );
    if (_v0.$ === "Nothing") {
  ...
  var $rtfeldman$elm_css$VirtualDom$Styled$unstyle = F3(
    function (elemType, properties, children) {
      ...
      var initialStyles =
        $rtfeldman$elm_css$VirtualDom$Styled$stylesFromProperties(properties);
      var _v0 = A3(
        $elm$core$List$foldl,
        $rtfeldman$elm_css$VirtualDom$Styled$accumulateStyledHtml,
      ...
      return A3(
        ...
        elemType,
        unstyledProperties,
        A2($elm$core$List$cons, styleNode, $elm$core$List$reverse(childNodes)),
      );
    },
  );
    ...
    function (_default, pairs) {
      getUnusedKey: while (true) {
        if (!pairs.b) {
          ...
          if (
            A2($rtfeldman$elm_css$VirtualDom$Styled$containsKey, newKey, rest)
          ) {
  ...
  var $rtfeldman$elm_css$VirtualDom$Styled$toKeyedStyleNode = F2(
    function (allStyles, keyedChildNodes) {
      var styleNodeKey = A2(
        $rtfeldman$elm_css$VirtualDom$Styled$getUnusedKey,
        "_",
        keyedChildNodes,
      );
      var finalNode =
        $rtfeldman$elm_css$VirtualDom$Styled$toStyleNode(allStyles);
  ...
  var $rtfeldman$elm_css$VirtualDom$Styled$toUnstyled = function (vdom) {
    switch (vdom.$) {
      ...
      case "Node":
        ...
        var children = vdom.c;
        return A3(
          $rtfeldman$elm_css$VirtualDom$Styled$unstyle,
          elemType,
          properties,
          children,
        );
      case "NodeNS":
        ...
        var children = vdom.d;
        return A4(
          $rtfeldman$elm_css$VirtualDom$Styled$unstyleNS,
          ns,
          elemType,
          properties,
          children,
      ...
      case "KeyedNode":
        ...
        var children = vdom.c;
        return A3(
          $rtfeldman$elm_css$VirtualDom$Styled$unstyleKeyed,
          elemType,
          properties,
          children,
        );
      default:
        ...
        var children = vdom.d;
        return A4(
          $rtfeldman$elm_css$VirtualDom$Styled$unstyleKeyedNS,
          ns,
          elemType,
          properties,
          children,
  ...
  var $rtfeldman$elm_css$Html$Styled$toUnstyled =
    $rtfeldman$elm_css$VirtualDom$Styled$toUnstyled;
  ...
  var $rtfeldman$elm_css$Html$Styled$Attributes$css =
    $rtfeldman$elm_css$Html$Styled$Internal$css;
  var $rtfeldman$elm_css$VirtualDom$Styled$Node = F3(function (a, b, c) {
    return { $: "Node", a: a, b: b, c: c };
  });
  var $rtfeldman$elm_css$VirtualDom$Styled$node =
    $rtfeldman$elm_css$VirtualDom$Styled$Node;
  var $rtfeldman$elm_css$Html$Styled$node =
    $rtfeldman$elm_css$VirtualDom$Styled$node;
  var $rtfeldman$elm_css$Html$Styled$div =
    $rtfeldman$elm_css$Html$Styled$node("div");
  var $rtfeldman$elm_css$Html$Styled$h1 =
    $rtfeldman$elm_css$Html$Styled$node("h1");
  var $rtfeldman$elm_css$Html$Styled$h2 =
    $rtfeldman$elm_css$Html$Styled$node("h2");
  var $rtfeldman$elm_css$Html$Styled$h3 =
    $rtfeldman$elm_css$Html$Styled$node("h3");
  var $rtfeldman$elm_css$Html$Styled$h4 =
    $rtfeldman$elm_css$Html$Styled$node("h4");
  ...
  var $rtfeldman$elm_css$Html$Styled$iframe =
    $rtfeldman$elm_css$Html$Styled$node("iframe");
  var $rtfeldman$elm_css$Html$Styled$img =
    $rtfeldman$elm_css$Html$Styled$node("img");
  var $rtfeldman$elm_css$Css$prop1 = F2(function (key, arg) {
    return A2($rtfeldman$elm_css$Css$property, key, arg.value);
  });
  var $rtfeldman$elm_css$Css$marginBottom =
    $rtfeldman$elm_css$Css$prop1("margin-bottom");
  var $rtfeldman$elm_css$Html$Styled$p =
    $rtfeldman$elm_css$Html$Styled$node("p");
  ...
  var $rtfeldman$elm_css$Html$Styled$Attributes$property =
    ...
    function (units, unitLabel, numericValue) {
      return {
        ...
        lengthOrAutoOrCoverOrContain:
          $rtfeldman$elm_css$Css$Structure$Compatible,
  ...
  var $rtfeldman$elm_css$Css$px = A2(
    $rtfeldman$elm_css$Css$Internal$lengthConverter,
    $rtfeldman$elm_css$Css$PxUnits,
    "px",
  );
  ...
  var $rtfeldman$elm_css$Html$Styled$Attributes$style =
    $rtfeldman$elm_css$VirtualDom$Styled$style;
  var $rtfeldman$elm_css$VirtualDom$Styled$text = function (str) {
    return $rtfeldman$elm_css$VirtualDom$Styled$Unstyled(
      $elm$virtual_dom$VirtualDom$text(str),
    );
  };
  var $rtfeldman$elm_css$Html$Styled$text =
    $rtfeldman$elm_css$VirtualDom$Styled$text;
            ...
            A2(
              ...
              _List_fromArray([
                $rtfeldman$elm_css$Html$Styled$text(
                  "On this page I put some fun apis I like.",
                ),
              ]),
            ),
            A2(
                        ...
                        return A2(
                          ...
                          _List_fromArray([
                            A2(
                              ...
                              _List_fromArray([
                                $rtfeldman$elm_css$Html$Styled$text(
                                  "There was an error getting the joke with status:",
                                ),
                              ]),
                            ),
                            A2(
                    ...
                    return A2(
                      ...
                      _List_fromArray([
                        A2(
                          ...
                          _List_fromArray([
                            $rtfeldman$elm_css$Html$Styled$text(
                              "There was an error getting the image with status:",
                            ),
                          ]),
                        ),
                        A2(
  ...
  var $rtfeldman$elm_css$Css$displayFlex = A2(
        ...
        switch (style.$) {
          case "AppendProperty":
            ...
            var key = A2(
              $elm$core$Maybe$withDefault,
              "",
              $elm$core$List$head(A2($elm$core$String$split, ":", str)),
            );
            return A2(
              $rtfeldman$elm_css$Css$Internal$property,
              desiredKey,
              key,
            );
          case "ExtendSelector":
            ...
            return A2(
              ...
              "elm-css-error-cannot-apply-" +
                (functionName + "-with-inapplicable-Style-for-selector"),
            );
          case "NestSnippet":
            ...
            return A2(
              ...
              desiredKey,
              "elm-css-error-cannot-apply-" +
                (functionName + "-with-inapplicable-Style-for-combinator"),
            );
          case "WithPseudoElement":
          ...
          case "WithMedia":
            return A2(
              ...
              desiredKey,
              "elm-css-error-cannot-apply-" +
                (functionName + "-with-inapplicable-Style-for-media-query"),
            );
          case "WithKeyframes":
            return A2(
              $rtfeldman$elm_css$Css$Internal$property,
              desiredKey,
              "elm-css-error-cannot-apply-" +
                (functionName + "-with-inapplicable-Style-for-keyframes"),
            );
          default:
            if (!style.a.b) {
              return A2(
              ...
              if (!style.a.b.b) {
                ...
                var $temp$functionName = functionName,
                  $temp$desiredKey = desiredKey,
                  $temp$style =
                    $rtfeldman$elm_css$Css$Preprocess$ApplyStyles(rest);
                functionName = $temp$functionName;
                desiredKey = $temp$desiredKey;
                style = $temp$style;
                continue getOverloadedProperty;
  ...
  var $rtfeldman$elm_css$Css$Internal$lengthForOverloadedProperty = A3(
    $rtfeldman$elm_css$Css$Internal$lengthConverter,
    $rtfeldman$elm_css$Css$Internal$IncompatibleUnits,
    "",
    0,
  );
  ...
  var $rtfeldman$elm_css$Css$prop3 = F4(function (key, argA, argB, argC) {
    return A2(
      ...
      A2(
        $elm$core$String$join,
        " ",
        _List_fromArray([argA.value, argB.value, argC.value]),
      ),
    );
  });
  var $rtfeldman$elm_css$Css$border3 = $rtfeldman$elm_css$Css$prop3("border");
  var $rtfeldman$elm_css$Css$borderRadius =
    $rtfeldman$elm_css$Css$prop1("border-radius");
  var $rtfeldman$elm_css$Css$cursor = $rtfeldman$elm_css$Css$prop1("cursor");
  var $rtfeldman$elm_css$Css$fontSize =
    $rtfeldman$elm_css$Css$prop1("font-size");
  ...
  var $rtfeldman$elm_css$Css$hover =
    $rtfeldman$elm_css$Css$pseudoClass("hover");
  var $rtfeldman$elm_css$Css$maxHeight =
    $rtfeldman$elm_css$Css$prop1("max-height");
  var $rtfeldman$elm_css$Css$maxWidth =
    $rtfeldman$elm_css$Css$prop1("max-width");
  var $rtfeldman$elm_css$Css$prop2 = F3(function (key, argA, argB) {
    return A2(
      $rtfeldman$elm_css$Css$property,
      key,
      A2($elm$core$String$join, " ", _List_fromArray([argA.value, argB.value])),
    );
  });
  ...
  var $author$project$CVPage$buttonStyles = _List_fromArray([
    ...
    $rtfeldman$elm_css$Css$fontSize($rtfeldman$elm_css$Css$px(20)),
    $rtfeldman$elm_css$Css$fontWeight($rtfeldman$elm_css$Css$bold),
    $rtfeldman$elm_css$Css$color($rtfeldman$elm_css$Css$hex("#ffffff")),
    $rtfeldman$elm_css$Css$backgroundColor(
      $rtfeldman$elm_css$Css$hex("#530082"),
    ),
    $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$px(6)),
    A3(
    ...
    $rtfeldman$elm_css$Css$maxHeight($rtfeldman$elm_css$Css$px(60)),
    $rtfeldman$elm_css$Css$maxWidth($rtfeldman$elm_css$Css$px(200)),
    $rtfeldman$elm_css$Css$hover(
      _List_fromArray([
        $rtfeldman$elm_css$Css$backgroundColor(
          $rtfeldman$elm_css$Css$hex("#380057"),
        ),
        $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$px(10)),
      ]),
    ),
  ]);
  var $rtfeldman$elm_css$Css$prop4 = F5(function (key, argA, argB, argC, argD) {
    return A2(
      ...
      A2(
        $elm$core$String$join,
        " ",
        _List_fromArray([argA.value, argB.value, argC.value, argD.value]),
      ),
    );
  });
  ...
  var $author$project$CVPage$viewAcademic = A2(
    ...
    _List_fromArray([
      A2(
        ...
        _List_fromArray([
          $rtfeldman$elm_css$Html$Styled$text(
            "My academic interests and experience lie in theoretical and computational physics",
          ),
        ]),
      ),
      A2(
      ...
      A2(
        $rtfeldman$elm_css$Html$Styled$h3,
        _List_Nil,
        _List_fromArray([$rtfeldman$elm_css$Html$Styled$text("Abstract")]),
      ),
      A2(
        $rtfeldman$elm_css$Html$Styled$p,
        _List_Nil,
      ...
      A2(
        ...
        _List_fromArray([
          $rtfeldman$elm_css$Html$Styled$Events$onClick(
            $author$project$CVPage$DownloadThesis,
          ),
          $rtfeldman$elm_css$Html$Styled$Attributes$css(
            $author$project$CVPage$buttonStyles,
          ),
        ]),
        _List_fromArray([
  ...
  var $rtfeldman$elm_css$Html$Styled$a =
    $rtfeldman$elm_css$Html$Styled$node("a");
  ...
  var $rtfeldman$elm_css$Html$Styled$Attributes$target =
    $rtfeldman$elm_css$Html$Styled$Attributes$stringProperty("target");
  var $author$project$CVPage$viewHalloween = A2(
    ...
    _List_fromArray([
      A2(
        $rtfeldman$elm_css$Html$Styled$h2,
        _List_Nil,
        _List_fromArray([$rtfeldman$elm_css$Html$Styled$text("Halloween")]),
      ),
      A2(
        $rtfeldman$elm_css$Html$Styled$h4,
        _List_Nil,
          ...
          A2(
            ...
            _List_fromArray([
              $rtfeldman$elm_css$Html$Styled$Attributes$href(
                "https://sachapf.github.io/halloween2021/",
              ),
      ...
      A2(
        ...
        _List_fromArray([
          $rtfeldman$elm_css$Html$Styled$text(
            "The premise of the party (sent to the guests before arriving) is as follows:",
          ),
          A2(
            $rtfeldman$elm_css$Html$Styled$p,
            _List_Nil,
      ...
      A2(
        ...
        _List_fromArray([
          A2(
            ...
            _List_fromArray([
              $rtfeldman$elm_css$Html$Styled$Attributes$href(
                "https://sachapf.github.io/halloween2020/",
              ),
              $rtfeldman$elm_css$Html$Styled$Attributes$target("_blank"),
            ]),
            _List_fromArray([
      ...
      A2(
        ...
        _List_fromArray([
          A2(
            ...
            _List_fromArray([
              $rtfeldman$elm_css$Html$Styled$Attributes$href(
                "https://play.google.com/store/apps/details?id=com.HalloweenInc.HalloweenApp",
              ),
              $rtfeldman$elm_css$Html$Styled$Attributes$target("_blank"),
            ]),
            _List_fromArray([
      ...
      A2(
        ...
        _List_fromArray([
          $rtfeldman$elm_css$Html$Styled$text(
            "Upon arriving, the guests are informed that different dimensions have been embedded into different rooms of the house. To find out why this happened, they must perform tasks in each dimension. As they investigate, they learn of a young girl who died in the house long ago, whose soul has gone missing...",
          ),
          A2(
            $rtfeldman$elm_css$Html$Styled$p,
            _List_Nil,
            _List_fromArray([
              $rtfeldman$elm_css$Html$Styled$text(
                "The first few codes are: pumpkin031, wizard, rat, (in the vampire dimension, play the exorcist theme song), (in the ghost dimension, choose any answers). With the help of Daniel Lozano, we made an android app for the google play store.",
              ),
            ]),
          ),
        ]),
  ...
  var $author$project$CVPage$viewHobbies = A2(
    ...
    _List_fromArray([
      A2(
        $rtfeldman$elm_css$Html$Styled$h1,
        _List_Nil,
        _List_fromArray([$rtfeldman$elm_css$Html$Styled$text("Hobbies")]),
      ),
      A2(
        $rtfeldman$elm_css$Html$Styled$h4,
        _List_Nil,
        _List_fromArray([
          $rtfeldman$elm_css$Html$Styled$text(
            "I enjoy singing in choir or on my own. Most recently I was a part of the ",
          ),
          A2(
            $rtfeldman$elm_css$Html$Styled$a,
            _List_fromArray([
          ...
          $rtfeldman$elm_css$Html$Styled$text(
            ". Because of Corona, I had fewer concerts with them than planned but enjoyed performing the Bach Christmas Oratorio with them in 2019 and 2021.",
          ),
        ]),
      ),
      A2(
        ...
        _List_fromArray([
          $rtfeldman$elm_css$Html$Styled$text(
            "Previously, I sung with Les Muses Chorale while studying at McGill University.",
          ),
        ]),
      ),
      A2(
        ...
        _List_fromArray([
          ...
          $rtfeldman$elm_css$Html$Styled$Attributes$src(
            "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/450199737&color=%233a3a3a&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true",
          ),
          A2(
            $rtfeldman$elm_css$Html$Styled$Attributes$property,
            "frameborder",
      ...
      A2(
        ...
        _List_fromArray([
          $rtfeldman$elm_css$Html$Styled$text(
            "I also enjoy video making/editing",
          ),
        ]),
      ),
      A2(
        ...
        _List_fromArray([
          ...
          $rtfeldman$elm_css$Html$Styled$Attributes$src(
            "https://www.youtube.com/embed/ZAe2AKLzVSw",
          ),
          A2(
            $rtfeldman$elm_css$Html$Styled$Attributes$property,
            "frameborder",
  ...
  var $rtfeldman$elm_css$Css$flexDirection =
    $rtfeldman$elm_css$Css$prop1("flex-direction");
  ...
  var $author$project$CVPage$viewTabs = function (mdl) {
    var tabStyles = $rtfeldman$elm_css$Html$Styled$Attributes$css(
      _List_fromArray([
        $rtfeldman$elm_css$Css$padding($rtfeldman$elm_css$Css$px(25)),
    ...
    return A2(
      ...
      _List_fromArray([
        $rtfeldman$elm_css$Html$Styled$Attributes$css(
          _List_fromArray([
            ...
            $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$pct(10)),
            $rtfeldman$elm_css$Css$borderRadius($rtfeldman$elm_css$Css$px(20)),
            $rtfeldman$elm_css$Css$backgroundColor(
      ...
      _List_fromArray([
        A2(
          ...
          _List_fromArray([$rtfeldman$elm_css$Html$Styled$text("Academic")]),
        ),
        A2(
          $rtfeldman$elm_css$Html$Styled$div,
          _List_fromArray([
          ...
          _List_fromArray([$rtfeldman$elm_css$Html$Styled$text("Work")]),
        ),
        A2(
          $rtfeldman$elm_css$Html$Styled$div,
          _List_fromArray([
        ...
        A2(
          ...
          _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Events$onClick(
              $author$project$CVPage$SwitchTab(
                $author$project$CVPage$Halloween,
              ),
            ),
            tabStyles,
  ...
  var $author$project$CVPage$viewWork = A2(
    ...
    _List_fromArray([
      A2(
        ...
        _List_fromArray([
          A2(
            ...
            _List_fromArray([
              $rtfeldman$elm_css$Html$Styled$text(
                "I am currently employed at Improving Ottawa, also known as YoppWorks.",
              ),
            ]),
          ),
          A2(
            ...
            _List_fromArray([
              ...
              $rtfeldman$elm_css$Html$Styled$text(
                " where I was employed as a software developer, working on crowdfunding platforms.",
              ),
            ]),
          ),
          A2(
            ...
            _List_fromArray([
              $rtfeldman$elm_css$Html$Styled$text(
                "An example of one of the platforms we've made is ",
              ),
              A2(
                $rtfeldman$elm_css$Html$Styled$a,
                _List_fromArray([
              ...
              $rtfeldman$elm_css$Html$Styled$text(
                " which provides a great way of getting new products on the market, allowing for the general crowd to support farms and small businesses.",
              ),
            ]),
          ),
        ]),
      ...
      A2(
        ...
        _List_fromArray([
          $rtfeldman$elm_css$Html$Styled$Events$onClick(
            $author$project$CVPage$DownloadFile,
          ),
          $rtfeldman$elm_css$Html$Styled$Attributes$css(
            $author$project$CVPage$buttonStyles,
          ),
        ]),
        _List_fromArray([$rtfeldman$elm_css$Html$Styled$text("Download CV")]),
      ),
    ]),
  );
        ...
        A2(
          ...
          _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css(
              _List_fromArray([
                $rtfeldman$elm_css$Css$displayFlex,
                $rtfeldman$elm_css$Css$justifyContent(
                  $rtfeldman$elm_css$Css$center,
                ),
              ]),
            ),
          ]),
          _List_fromArray([$rtfeldman$elm_css$Html$Styled$text("Experience")]),
        ),
        A2(
          $rtfeldman$elm_css$Html$Styled$h4,
          _List_fromArray([
        ...
        A2(
          ...
          _List_fromArray([
            $rtfeldman$elm_css$Html$Styled$Attributes$css(
              _List_fromArray([
                $rtfeldman$elm_css$Css$displayFlex,
                $rtfeldman$elm_css$Css$padding($rtfeldman$elm_css$Css$px(10)),
              ]),
            ),
          ]),
          _List_fromArray([
  ...
  var $rtfeldman$elm_css$Css$paddingBottom =
    $rtfeldman$elm_css$Css$prop1("padding-bottom");
  var $author$project$MainPage$view = function (model) {
    return A2(
      ...
      _List_fromArray([
        $rtfeldman$elm_css$Html$Styled$Attributes$css(
          _List_fromArray([
            $rtfeldman$elm_css$Css$padding($rtfeldman$elm_css$Css$px(30)),
          ]),
        ),
      ]),
      _List_fromArray([
            ...
            A2(
              ...
              _List_fromArray([
                A2(
                  ...
                  _List_fromArray([
                    $rtfeldman$elm_css$Html$Styled$text(
                      "I am a physicist and software developer.",
                    ),
                  ]),
                ),
                A2(
                  ...
                  _List_fromArray([
                    $rtfeldman$elm_css$Html$Styled$text(
                      "My main interests lie in functional programming, cosmology and gravity.",
                    ),
                  ]),
                ),
              ]),
  ...
  var $rtfeldman$elm_css$Css$textDecoration =
    $rtfeldman$elm_css$Css$prop1("text-decoration");
  var $author$project$Tab$activeCss =
    $rtfeldman$elm_css$Html$Styled$Attributes$css(
      _List_fromArray([
  ...
  var $author$project$Tab$inactiveCss =
    $rtfeldman$elm_css$Html$Styled$Attributes$css(
      _List_fromArray([
        $rtfeldman$elm_css$Css$width($rtfeldman$elm_css$Css$px(120)),
        $rtfeldman$elm_css$Css$displayFlex,
  ...
  var $rtfeldman$elm_css$Css$boxShadow5 =
    $rtfeldman$elm_css$Css$prop5("box-shadow");
  ...
  var $author$project$Navigation$viewTabs = function (page) {
    return A2(
      ...
      _List_Nil,
      _List_fromArray([
        $author$project$Tab$tabsWrapper(
          A2(
            $elm$core$List$map,
            function (p) {
              return A2(
                $rtfeldman$elm_css$Html$Styled$a,
                _List_fromArray([
                  _Utils_eq(p.b.page, page)
                    ? $author$project$Tab$activeCss
                    : $author$project$Tab$inactiveCss,
                ...
                case "APITest":
                  ...
                  if (_v1.$ === "Just") {
                    ...
                    return A2(
                      ...
                      $rtfeldman$elm_css$Html$Styled$toUnstyled(
                        $author$project$APIPage$view(mmd),
                      ),
                    );
                  } else {

...
var $author$project$Main$Model = F8(
	function (key, url, mainModel, apiModel, cvModel, bonusPlotsModel, message, currentPage) {
		return {apiModel: apiModel, bonusPlotsModel: bonusPlotsModel, currentPage: currentPage, cvModel: cvModel, key: key, mainModel: mainModel, message: message, url: url};
	});
var $author$project$Main$APIMsg = function (a) {
	return {$: 'APIMsg', a: a};
};
var $author$project$Navigation$APITest = {$: 'APITest'};
var $author$project$Main$BPMsg = function (a) {
	return {$: 'BPMsg', a: a};
};
var $author$project$Navigation$BonusPlots = {$: 'BonusPlots'};
...
var $author$project$BonusPlots$Model = F2(
	function (test, message) {
		return {message: message, test: test};
	});
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$BonusPlots$init = function (_v0) {
	return _Utils_Tuple2(
		A2($author$project$BonusPlots$Model, 'Starting it up', $elm$core$Maybe$Nothing),
...
var $author$project$Navigation$navPageList = _List_fromArray(
	[
		_Utils_Tuple2(
		'',
...
var $author$project$Navigation$pageList = _Utils_ap(
	$author$project$Navigation$navPageList,
	_List_fromArray(
		[
			_Utils_Tuple2(
			'#bonusplots',
			A2($author$project$Navigation$PageInfo, 'Bonus Plots', $author$project$Navigation$BonusPlots))
		]));
...
var $author$project$BonusPlots$update = F2(
	function (msg, model) {
		var s = msg.a;
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				if (route.$ === 'Just') {
					...
					switch (_v3.$) {
						...
						default:
							var _v7 = $author$project$BonusPlots$init(_Utils_Tuple0);
							var m = _v7.a;
							var c = _v7.b;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										bonusPlotsModel: $elm$core$Maybe$Just(m),
										currentPage: $author$project$Navigation$BonusPlots,
										url: url
									}),
								A2($elm$core$Platform$Cmd$map, $author$project$Main$BPMsg, c));
					}
				} else {
					var _v8 = $author$project$MainPage$init(_Utils_Tuple0);
					var m = _v8.a;
					var c = _v8.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'MainMsg':
				var b = msg.a;
				var _v9 = model.mainModel;
				if (_v9.$ === 'Just') {
					var a = _v9.a;
					var _v10 = A2($author$project$MainPage$update, b, a);
					var m = _v10.a;
					var c = _v10.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'APIMsg':
				var b = msg.a;
				var _v11 = model.apiModel;
				if (_v11.$ === 'Just') {
					var a = _v11.a;
					var _v12 = A2($author$project$APIPage$update, b, a);
					var m = _v12.a;
					var c = _v12.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'CVMsg':
				var c = msg.a;
				var _v13 = model.cvModel;
				if (_v13.$ === 'Just') {
					var mdl = _v13.a;
					var _v14 = A2($author$project$CVPage$update, c, mdl);
					var m = _v14.a;
					var cmd = _v14.b;
					return _Utils_Tuple2(
						_Utils_update(
			...
			default:
				var c = msg.a;
				var _v15 = model.bonusPlotsModel;
				if (_v15.$ === 'Just') {
					var mdl = _v15.a;
					var _v16 = A2($author$project$BonusPlots$update, c, mdl);
					var m = _v16.a;
					var cmd = _v16.b;
					return _Utils_Tuple2(
						_Utils_update(
						...
						A2($elm$core$Platform$Cmd$map, $author$project$Main$BPMsg, cmd));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		var _v0 = A2(
			...
			A8($author$project$Main$Model, key, url, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, $elm$core$Maybe$Nothing, $author$project$Navigation$Main));
		var mdl = _v0.a;
		var msg = _v0.b;
...
var $author$project$BonusPlots$viewDescription = function (maybeDescription) {
	if (maybeDescription.$ === 'Just') {
...
var $author$project$BonusPlots$viewPlot = F3(
	function (header, file, maybeDescription) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
			...
			_Utils_ap(
				...
				_Utils_ap(
					$author$project$BonusPlots$viewDescription(maybeDescription),
					_List_fromArray(
						[
							A2(
							$rtfeldman$elm_css$Html$Styled$img,
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$src(file),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$width(
...
var $author$project$BonusPlots$view = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Bonus Plots')
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A3($author$project$BonusPlots$viewPlot, 'Diffusion Process for SFH/MH Inference - samples', 'Files/bonus_plots/inference_SFH_metallicity_4.gif', $elm$core$Maybe$Nothing),
						A3(
						$author$project$BonusPlots$viewPlot,
						'Diffusion Process for SFH/MH Inference - spectrum',
						'Files/bonus_plots/spectrum_diffusion_process_4.gif',
						$elm$core$Maybe$Just('The spectrum is generated by the samples in the previous plot, so it also evolves during the diffusion process.')),
						A3($author$project$BonusPlots$viewPlot, 'Mass Estimates Comparison: TNG vs TNG', 'Files/bonus_plots/comparison_4_total_mass_log.png', $elm$core$Maybe$Nothing),
						A3($author$project$BonusPlots$viewPlot, 'Example MaNGA SFH and Z Samples for 1-623722', 'Files/bonus_plots/example_MaNGA_samples_1-623722.png', $elm$core$Maybe$Nothing),
						A3(
						$author$project$BonusPlots$viewPlot,
						'PQMass Chi2 Comparison: TNG Train vs Test',
						'Files/bonus_plots/chi2_TNG_train_vs_test.png',
						$elm$core$Maybe$Just('PQMass is a statistical test that checks if two datasets were sampled from the same distribution. When they are, then the resulting plot should appear as a Chi^2 distribution with 99 degrees of freedom. In this case, I am comparing TNG train versus test, which are literally from the same distribution.')),
						A3(
						$author$project$BonusPlots$viewPlot,
						'PQMass Chi2 Comparison: Model Samples vs Test',
						'Files/bonus_plots/chi2_test_300_0_TNG_vs_test.png',
						$elm$core$Maybe$Just('PQMass for model samples versus test. This shows the samples are in distribution, though they are not perfect.')),
						A3(
						$author$project$BonusPlots$viewPlot,
						'PQMass Chi2 Comparison: TNG vs Eagle',
						'Files/bonus_plots/chi2_tng_vs_eagle.png',
						$elm$core$Maybe$Just('PQMass for TNG versus Eagle. This shows that TNG and EAGLE are out-of-distribution with respect to each other.')),
						A3(
						$author$project$BonusPlots$viewPlot,
						'SSP Mass Comparison',
						'Files/bonus_plots/SSP_comparison_Mass.png',
						$elm$core$Maybe$Just('MaNGA mass estimates for different choices of SSPs. Note - MaStar Salpeter uses 2.35 but isn\'t actually Salpeter')),
						A3(
						$author$project$BonusPlots$viewPlot,
						'SSP Mass Comparison',
						'Files/bonus_plots/SSP_comparison.png',
						$elm$core$Maybe$Just('MaNGA metallicity estimates for different choices of SSPs. Note - MaStar Salpeter uses 2.35 but isn\'t actually Salpeter'))
					]))
			]));
};
...
var $author$project$CVPage$viewAcademic = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('My research interests are centred in cosmology, but I am equally fascinated by the laws of physics that govern the Universe.')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$h2,
			_List_Nil,
...
var $author$project$CVPage$viewHalloween = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Here I display information about iterations from several years ago. The newer versions of the apps are connected to a database, which must be reset to restart the games and allow them to be played again. While they cannot be played currently, the urls are: '),
					A2(
					$rtfeldman$elm_css$Html$Styled$a,
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$href('https://pf-physics.github.io/Halloween2025/'),
							$rtfeldman$elm_css$Html$Styled$Attributes$target('_blank')
						]),
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Halloween 2025')
						])),
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$href('https://pf-physics.github.io/Halloween2024/'),
							$rtfeldman$elm_css$Html$Styled$Attributes$target('_blank')
						]),
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Halloween 2024')
						])),
					$rtfeldman$elm_css$Html$Styled$text(', '),
					A2(
					$rtfeldman$elm_css$Html$Styled$a,
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$href('https://pf-physics.github.io/Halloween2022/'),
							$rtfeldman$elm_css$Html$Styled$Attributes$target('_blank')
						]),
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Halloween 2022')
						])),
					$rtfeldman$elm_css$Html$Styled$text('.')
				])),
			A2(
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Html$Styled$text('The codes for the games can be found on the '),
					A2(
					$rtfeldman$elm_css$Html$Styled$a,
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$href('https://github.com/pf-physics/halloween2021'),
							$rtfeldman$elm_css$Html$Styled$Attributes$target('_blank')
						]),
					_List_fromArray(
						[
					...
					$rtfeldman$elm_css$Html$Styled$text(' page.')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$h3,
			_List_Nil,
...
var $author$project$CVPage$viewHobbies = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('I enjoy singing in choir or on my own. Choirs I have been a part of include the '),
					A2(
					$rtfeldman$elm_css$Html$Styled$a,
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$href('https://lesmuseschorale.wordpress.com/'),
							$rtfeldman$elm_css$Html$Styled$Attributes$target('_blank')
						]),
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('Les Muses Chorale')
						])),
					$rtfeldman$elm_css$Html$Styled$text('.')
				])),
			A2(
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('I enjoy writing fiction and coming up with stories. This is a hobby I practice mostly through inventing the plots of my Halloween events, but I will submit my writing to competitions when I am made aware of them.')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$h3,
			_List_Nil,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Another hobby of mine is video making/editing. Here is a music video I made in 2018. While I have continued making shorter videos over the years, I haven\'t had the chance to take on as big of a project since then.')
				])),
			A2(
			...
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Html$Styled$Attributes$width(640)
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Attributes$src('/Files/Tiny_video.mp4'),
							$rtfeldman$elm_css$Html$Styled$Attributes$type_('video/mp4')
						]),
					_List_Nil)
				]))
		]));
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('My most recent role was as a software developer at Improving Ottawa, also known as '),
							A2(
							$rtfeldman$elm_css$Html$Styled$a,
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$href('https://yoppworks.com/'),
									$rtfeldman$elm_css$Html$Styled$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('YoppWorks')
								])),
							$rtfeldman$elm_css$Html$Styled$text('.')
						])),
					A2(
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('One project I worked on was Where2GoCanada which is a mobile web app whose purpose is to help Ukrainian refugees find the ideal place in Canada to move to, based on their employment experience.')
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$p,
					_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$src('Files/Sacha.jpg'),
										$rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[
												$rtfeldman$elm_css$Css$height(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('I am a PhD at the Université de Montréal, in physics and machine learning. My research involves using diffusion models to infer star formation histories from galaxy spectra.')
									]))
							]))
					]))
			]));
				...
				[
					...
					function () {
						...
						switch (_v0.$) {
							...
							default:
								var _v4 = model.bonusPlotsModel;
								if (_v4.$ === 'Just') {
									var bpMdl = _v4.a;
									return A2(
										$elm$html$Html$map,
										$author$project$Main$BPMsg,
										$rtfeldman$elm_css$Html$Styled$toUnstyled(
											$author$project$BonusPlots$view(bpMdl)));
								} else {
									return $elm$html$Html$text('Page load fail');
								}
						}

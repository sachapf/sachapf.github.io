...
view model =
  ...
  , div [ css [ displayFlex, justifyContent left ] ]
    ...
    , p [ css [ fontSize (px 20), Css.width (pct 200)] ]
      [ p [] [text "I am a PhD at the Université de Montréal, in physics and machine learning. My research involves using diffusion models to infer star formation histories from galaxy spectra."]
      ]
    ]
  ]
